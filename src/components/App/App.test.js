...
describe('APP', () => {
  ...
  it('when cards are clicked they should be given the class selected and also placed in state', () => {
  ...
  it('when two cards are compared it should create a comparison card and render it to the page', () => {
    const wrapper = mount(<App />)
    const lastMockDist = {
      data: {2004:0, 2005:1, 2006:1, 2007:1 ,2008:1,2009:1,2010:1,2011:1,2012:1,2013:1,2014:1},
      location: "YUMA SCHOOL DISTRICT 1"
